		...
		<div class="container-fluid">
			...
			<div class="row">
				<div style="padding:0"  class="col-md-4 col-xs-12 text-black">
					...
					<div class="col-md-12 col-sm-6">
						<div style="border:1px solid #532d3a" class="panel">
							<div style="background-color:#532d3a; color:white;" class="panel-heading">Slide #4 Text</div>
							<div class="panel-body">
					...
					<div class="isotope">
						...
						if ($images->num_rows > 0) {
							while($image = $images->fetch_assoc()) {
								echo '<div class="col-lg-3 col-md-3 col-sm-3 item ' . strtolower($image["category"]) . '">
